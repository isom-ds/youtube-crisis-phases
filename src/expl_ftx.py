...
from utils import noOutlier, emotionGroup, describeEvent, plotLine, plotStack, clusterKMeans, normalityTest, diffTest, plotBox, phaseKMeans, diffTestPhase

#%%
# Load Data
# Videos
f = open ('data/ftx_videos.json', "r")
...
# Export dataframe
df_vid_stats_date.to_csv('out/ftx_stats_date.csv', index=False)

# Plot total views each day
plotLine(df_vid_stats_date, 'commentSum', ['2022-10-01', '2023-01-30'])
...
# Export dataframe
df_comments.to_csv('out/ftx_comments.csv', index=False)

# Summarise comment emotions
df_comments_emotion, df_comments_emotion100 = plotStack(df_comments, ['2022-10-01', '2023-01-30'])

# Export dataframe
df_comments_emotion100.to_csv('out/ftx_comments_emotion100.csv', index=False)

# %%
# Summarise comment valence
df_comments_valence, df_comments_valence100 = plotStack(df_comments, ['2022-10-01', '2023-01-30'], valence=True)

# %%
# Clustering
phases = clusterKMeans(df_comments_emotion.fillna(0), df_comments_emotion100.fillna(0), 4)
...
# Export dataframe
df_comments_emotion100.to_csv('out/ftx_comments_emotion100_notime.csv', index=False)
...
# Hypothesis
diffTest(df_comments_emotion100, norm, 4)
...
# %%
# Phases
phases = phaseKMeans(df_comments_emotion.fillna(0), df_comments_emotion100.fillna(0), 5)
df_comments_emotion100['phase'] = phases
describeEvent(df_comments_emotion100, df_comments_emotion100.columns.drop(['phase', 'date']), clustered = True)

# Export dataframe
df_comments_emotion.to_csv('out/ftx_comments_emotion_time.csv', index=False)
df_comments_emotion100.to_csv('out/ftx_comments_emotion100_time.csv', index=False)
...
# Hypothesis
diffTestPhase(df_comments_emotion100, norm, 5)
