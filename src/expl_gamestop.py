...
# Export dataframe
df_vid_stats_date.to_csv('out/gamestop_stats_date.csv', index=False)
...
# Export dataframe
df_comments.to_csv('out/gamestop_comments.csv', index=False)

# Summarise comment emotions
df_comments_emotion, df_comments_emotion100 = plotStack(df_comments, ['2021-01-01', '2021-02-28'])

# Export dataframe
df_comments_emotion100.to_csv('out/gamestop_comments_emotion100.csv', index=False)
...
# Export dataframe
df_comments_emotion100.to_csv('out/gamestop_comments_emotion100_notime.csv', index=False)
...
# Export dataframe
df_comments_emotion.to_csv('out/gamestop_comments_emotion_time.csv', index=False)
df_comments_emotion100.to_csv('out/gamestop_comments_emotion100_time.csv', index=False)
